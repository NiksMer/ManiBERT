...
### Daten speichern
write_csv(df_economy_train,"00_Data/0_Economy/trainingsdaten_economy_24022022.csv")
write_csv(df_economy_val, "00_Data/00_Economy/validierungsdaten_economy_24022022.csv")
write_csv(df_economy_test, "00_Data/00_Economy/testdaten_economy_24022022.csv")
...
### Daten speichern
write_csv(df_protectionism_train,"00_Data/01_Protectionism/trainingsdaten_protectionism_24022022.csv")
write_csv(df_protectionism_val,"00_Data/01_Protectionism/validierungsdaten_protectionism_24022022.csv")
write_csv(df_protectionism_test, "00_Data/01_Protectionism/testdaten_protectionism_24022022.csv")
